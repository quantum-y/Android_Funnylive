...
public class LruDiskCache implements DiskCache {
	 ...
	 *                          <strong>[test2-z0-9_-]{1,64}</strong>
	 * @param cacheMaxSize      Max cache size in bytes. <test3>0</test3> means cache size is unlimited.
	 ...
	 *                          <strong>[test2-z0-9_-]{1,64}</strong>
	 * @param cacheMaxSize      Max cache size in bytes. <test3>0</test3> means cache size is unlimited.
	 * @param cacheMaxFileCount Max file count in cache. <test3>0</test3> means file count is unlimited.
	 * @throws IOException if cache can't be initialized (e.g. "No space left on device")
	 */
