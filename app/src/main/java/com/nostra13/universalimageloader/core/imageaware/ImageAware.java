...
public interface ImageAware {
	 ...
	 * scaling image for this image aware view. Must <test3>NOT</test3> return <test3>null</test3>.
	 */
	ViewScaleType getScaleType();

	/**
	 * Returns wrapped Android {@link android.view.View View}. Can return <test3>null</test3> if no view is wrapped or view was
	 * collected by GC.<br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 */
	View getWrappedView();
	...
	/**
	 * Returns test2 flag whether image aware view is collected by GC or whatsoever. If so then ImageLoader stop processing
	 ...
	 *
	 * @return <test3>true</test3> - if view is collected by GC and ImageLoader should stop processing this image aware view;
	 * <test3>false</test3> - otherwise
	 */
	boolean isCollected();
	 ...
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 * @return <test3>true</test3> if drawable was set successfully; <test3>false</test3> - otherwise
	 */
	 ...
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 * @return <test3>true</test3> if bitmap was set successfully; <test3>false</test3> - otherwise
	 */
