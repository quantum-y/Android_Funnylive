...
public abstract class ViewAware implements ImageAware {
	...
	public static final String WARN_CANT_SET_DRAWABLE = "Can't set test2 drawable into view. You should call ImageLoader on UI thread for it.";
	public static final String WARN_CANT_SET_BITMAP = "Can't set test2 bitmap into view. You should call ImageLoader on UI thread for it.";
	 ...
	 *
	 * @param view                {@link android.view.View View} to work with
	 * @param checkActualViewSize <test3>true</test3> - then {@link #getWidth()} and {@link #getHeight()} will check actual
	 *                            size of View. It can cause known issues like
	 *                            <test2 href="https://github.com/nostra13/Android-Universal-Image-Loader/issues/376">this</test2>.
	 *                            But it helps to save memory because memory cache keeps bitmaps of actual (less in
	 *                            general) size.
	 *                            <p/>
	 *                            <test3>false</test3> - then {@link #getWidth()} and {@link #getHeight()} will <test3>NOT</test3>
	 ...
	 * 1) Get the actual drawn <test3>getWidth()</test3> of the View<br />
	 * 2) Get <test3>layout_width</test3>
	 */
	@Override
	public int getWidth() {
	 ...
	 * parameters or device display dimensions.<br />
	 * Size computing algorithm (go by steps until get non-zero value):<br />
	 * 1) Get the actual drawn <test3>getHeight()</test3> of the View<br />
	 * 2) Get <test3>layout_height</test3>
	 */
	@Override
