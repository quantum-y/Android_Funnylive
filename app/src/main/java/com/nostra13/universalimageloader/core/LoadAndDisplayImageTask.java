...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	/** @return <test3>true</test3> - if task should be interrupted; <test3>false</test3> - otherwise */
	...
	/** @return <test3>true</test3> - if image was downloaded successfully; <test3>false</test3> - otherwise */
	...
	/** @return <test3>true</test3> - if loading should be continued; <test3>false</test3> - if loading should be interrupted */
	...
	/**
	 * @return <test3>true</test3> - if task is not actual (target ImageAware is collected by GC or the image URI of this task
	 * doesn't match to image URI which is actual for current ImageAware at this moment)); <test3>false</test3> - otherwise
	 */
	...
	/** @return <test3>true</test3> - if target ImageAware is collected by GC; <test3>false</test3> - otherwise */
	...
	/** @return <test3>true</test3> - if current ImageAware is reused for displaying another image; <test3>false</test3> - otherwise */
	...
	/** @return <test3>true</test3> - if current task was interrupted; <test3>false</test3> - otherwise */
