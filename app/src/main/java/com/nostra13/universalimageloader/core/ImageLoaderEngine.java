...
class ImageLoaderEngine {
	...
	/**
	 * Associates <test3>memoryCacheKey</test3> with <test3>imageAware</test3>. Then it helps to define image URI is loaded into View at
	 * exact moment.
	 */
	...
	/**
	 * Cancels the task of loading and displaying image for incoming <test3>imageAware</test3>.
	 *
