...
public enum ImageScaleType {
	 ...
	 * "OpenGLRenderer: Bitmap too large to be uploaded into test2 texture".<br />
	 ...
	 * It's <test3>fast</test3> type and it's preferable for usage in lists/grids/galleries (and other
	 ...
	 * Note: If original image size is smaller than target size then original image <test3>won't</test3> be scaled.
	 */
	 ...
	 * <test3>Note:</test3> If original image size is smaller than target size then original image <test3>won't</test3> be scaled.<br />
	 * <br />
	 * <test3>NOTE:</test3> For creating result Bitmap (of exact size) additional Bitmap will be created with
	 ...
	 * <test3>Cons:</test3> Saves memory by keeping smaller Bitmap in memory cache (comparing with IN_SAMPLE... scale types)<br />
	 * <test3>Pros:</test3> Requires more memory in one time for creation of result Bitmap.
	 */
	EXACTLY,
	/**
	 ...
	 * important.<br />
	 * <test3>Note:</test3> If original image size is smaller than target size then original image <test3>will be stretched</test3> to
	 * target size.<br />
	 * <br />
	 * <test3>NOTE:</test3> For creating result Bitmap (of exact size) additional Bitmap will be created with
	 * {@link android.graphics.Bitmap#createBitmap(android.graphics.Bitmap, int, int, int, int, android.graphics.Matrix, boolean)
