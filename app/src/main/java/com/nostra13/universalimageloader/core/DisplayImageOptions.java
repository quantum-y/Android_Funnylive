...
public final class DisplayImageOptions {
	...
	public static class Builder {
		 ...
		 * string) will be passed to <test3>ImageLoader.displayImage(...)</test3> method.
		 *
		 * @param imageRes Image resource
		 */
		 ...
		 * image aware view} will be reset (set <test3>null</test3>) before image loading start
		 *
		 ...
		 * <test3>NOTE:</test3> {@link Options#inSampleSize} of incoming options will <test3>NOT</test3> be considered. Library
		 * calculate the most appropriate sample size itself according yo {@link #imageScaleType(ImageScaleType)}
		 * options.<br />
		 * <test3>NOTE:</test3> This option overlaps {@link #bitmapConfig(android.graphics.Bitmap.Config) bitmapConfig()}
		 * option.
		 */
	 ...
	 * <ul>
	 * <li>View will <test3>not</test3> be reset before loading</li>
	 * <li>Loaded image will <test3>not</test3> be cached in memory</li>
	 * <li>Loaded image will <test3>not</test3> be cached on disk</li>
