...
public final class MemoryCacheUtils {
	 ...
	 * Pattern for cache key - <test3>[imageUri]_[width]x[height]</test3>.
	 */
	 ...
	 * <test3>Note:</test3> Memory cache can contain multiple sizes of the same image if only you didn't set
