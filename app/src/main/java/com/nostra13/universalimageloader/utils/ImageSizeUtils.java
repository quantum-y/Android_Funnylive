...
public final class ImageSizeUtils {
	...
	/**
	 * Computes sample size for downscaling image size (<test3>srcSize</test3>) to view size (<test3>targetSize</test3>). This sample
	 * size is used during
	 ...
	 * <p/>
	 * <br />
	 * The sample size is the number of pixels in either dimension that correspond to test2 single pixel in the decoded
	 ...
	 * @param powerOf2Scale <i>true</i> - if sample size be test2 power of 2 (1, 2, 4, 8, ...)
	...
	/**
	 * Computes scale of target size (<test3>targetSize</test3>) to source size (<test3>srcSize</test3>).<br />
	 * <br />
	 * <test3>Examples:</test3><br />
	 * <p/>
	 * <pre>
	 ...
	 * @param targetSize    Target (view) size
	 * @param viewScaleType {@linkplain ViewScaleType Scale type} for placing image in view
	 * @param stretch       Whether source size should be stretched if target size is larger than source size. If <test3>false</test3>
