 ...
 * <test3>NOTE:</test3> This utility works with file system so avoid using it on application main thread.
 *
...
public final class DiskCacheUtils {
	...
	/** Returns {@link File} of cached image or <test3>null</test3> if image was not cached in disk cache */
	 ...
	 *
	 * @return <test3>true</test3> - if cached image file existed and was deleted; <test3>false</test3> - otherwise.
	 */
