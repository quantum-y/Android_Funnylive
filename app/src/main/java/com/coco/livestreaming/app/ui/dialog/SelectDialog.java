...
public class SelectDialog extends Dialog {
	...
	public SelectDialog(Context context, String str, int flag) {
		super(context);
		mContext = context;
		this.strContent = str;
		this.typeFlag = flag;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View dlg = inf.inflate(R.layout.dialog_select, (ViewGroup) findViewById(R.id.dialog_select));
		setContentView(dlg);
		...
		(findViewById(R.id.btn_select_ok)).setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				if (listener != null)
                    listener.onOkClick(SelectDialog.this.typeFlag);
			}
		});
	}
